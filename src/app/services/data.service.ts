...
export class DataService {
  ...
  initProfile(user: { sub: string; name: string; given_name: string; family_name: string; picture: string; email: string }): void {
    ...
    const p: UserProfile = {
      ...
      email: user.email,
      headline: 'Full-Stack Developer | Angular & Node.js | Apasionado por código limpio y arquitectura escalable',
      about: 'Desarrollador Full-Stack con experiencia construyendo aplicaciones web escalables. Especializado en Angular, Node.js y arquitecturas de microservicios. Mentor de desarrolladores junior y contribuidor open source. Creo que el buen código cuenta una historia y el software bien diseñado cambia vidas.',
      location: 'Guadalajara, México',
      industry: 'Desarrollo de Software',
      experience: [
        { id: 'e1', title: 'Ingeniero Full-Stack Senior', company: 'TechFlow Inc.', startDate: '2022-01', endDate: null, description: 'Lidero el desarrollo del frontend con Angular 19 (standalone components + signals) y el backend con Node.js y PostgreSQL. Migré el monolito a microservicios y reduje el tiempo de carga en 60%.' },
        { id: 'e2', title: 'Desarrollador Backend', company: 'StartupHub', startDate: '2020-03', endDate: '2021-12', description: 'Diseñé y construí APIs REST con Node.js, Express y MongoDB. Implementé CI/CD con GitHub Actions y Docker. Mantuve 99.9% de uptime.' },
        { id: 'e3', title: 'Desarrollador Junior', company: 'WebAgency', startDate: '2019-06', endDate: '2020-02', description: 'Desarrollé aplicaciones web con Angular y TypeScript. Aprendí mejores prácticas de testing con Jest y Cypress.' },
      ],
      education: [
        { id: 'ed1', school: 'Instituto Tecnológico de Guadalajara', degree: 'Ingeniería', field: 'Sistemas Computacionales', startYear: 2015, endYear: 2019 },
      ],
      skills: [
        { name: 'Angular', endorsements: 15, endorsedByMe: false },
        { name: 'TypeScript', endorsements: 11, endorsedByMe: false },
        { name: 'Node.js', endorsements: 9, endorsedByMe: false },
        { name: 'RxJS', endorsements: 6, endorsedByMe: false },
        { name: 'PostgreSQL', endorsements: 4, endorsedByMe: false },
        { name: 'Docker', endorsements: 5, endorsedByMe: false },
        { name: 'Jest', endorsements: 3, endorsedByMe: false },
        { name: 'CI/CD', endorsements: 7, endorsedByMe: false },
        { name: 'GraphQL', endorsements: 2, endorsedByMe: false },
        { name: 'TailwindCSS', endorsements: 4, endorsedByMe: false },
      ],
